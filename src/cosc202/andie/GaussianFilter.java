 ...
 * 
 * <p>
 * A Gaussian filter blurs the image by taking into account the pixels in a
 * local
 * neighbourhood (kernel). The closer the pixel is to the centre of the kernel
 * the
...
public class GaussianFilter implements ImageOperation, java.io.Serializable {
     ...
     * </p>
     * 
     * @param x        The horizontal distance from the current pixel to the middle
     *                 of the kernel.
     * @param y        The vertical distance from the current pixel to the middle of
     *                 the kernel.
